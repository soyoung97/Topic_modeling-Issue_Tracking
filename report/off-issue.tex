...
\begin{definition}
    $b$ has approximation of $\phi$ with bound $K, \epsilon$ iff there exists an Lipshitz continuous $\pi$ with $K$ that $d^{\#}(\pi(b(d)), \phi(d)) < \epsilon$.
\end{definition}
...
\begin{definition}
    $e$ is Lipschitz continuous with $K$ when $e^{\#}(e(d_{1}), e(d_{2})) \leq K d^{\#}(d_{1}, d_{2})$.
\end{definition}
...
\begin{theorem}
    ...
    $e^{\#}(\pi_{e}(b(d)), e(\phi(d))) < K_{e} \cdot \epsilon$. (it means $b$ has approximation of $e \cdot \phi$ with bound $K, K_{e} \cdot \epsilon$)
\end{theorem}
...
construction of $\pi$, $\phi$, $e$ or any other.